...
#
# tinygpgs: PDF file size optimizer (single-file script for Unix)
#
...
def main(argv):
  ...
  py_files = ['tinygpgs/%s' % entry for entry in os.listdir('lib/tinygpgs') if entry.endswith('.py') and entry != '__main__.py']
